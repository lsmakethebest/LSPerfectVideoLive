...
//    [_list2Content addObjectsFromArray:sectionArrays];
//    NSLog(@"%@",_list2Content);
...
//           NSArray *sortedSection = [theCollation sortedArrayFromArray:sectionArray collationStringSelector:@selector(name1)];
            ...
            [sectionArray sortUsingComparator:^NSComparisonResult(PersonModel * obj1, PersonModel * obj2) {
                return [obj1.name1 localizedCompare:obj2.name1];
            }];
            
          [_list2Content addObject:sectionArray];
        }
    }
